...
[assembly: OwinStartup(typeof(EwonShop.Web.App_Start.Startup))]

namespace EwonShop.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(EwonShopDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<EwonShopDbContext>());
